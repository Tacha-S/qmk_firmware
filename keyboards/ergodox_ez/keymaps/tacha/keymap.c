...
[L_COMMON] = LAYOUT_ergodox(  // layer 0 : default
  ...
  KC_LGUI,    KC_LALT,  _______,    KC_GRV,     KC_LBRC,
  ...
  TO(L_BEAKL),    _______,    _______,    _______,    _______,    _______,    KC_SLSH,
              _______,    _______,    _______,    _______,    _______,    KC_MINS,
  CK_GAME,     _______,    _______,    _______,    _______,    _______,    KC_EQL,
...
// right hand
    ...
    _______,    KC_QUOT,    KC_SCLN,     KC_DOT,    KC_COMM,       KC_J,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,    _______
),
