...
[L_COMMON] = LAYOUT_ergodox(  // layer 0 : default
  ...
  KC_TAB,     _______,    _______,    _______,    _______,    _______,    TO(L_QWERTY),
  KC_RCTL,    _______,    _______,    _______,    _______,    _______,
  KC_LSFT,    _______,    _______,    _______,    _______,    _______,    TO(L_QWPR),
  KC_LGUI,    MO(L_NUM),  KC_BSLS,    KC_GRV,     KC_LBRC,

              _______,    _______,
                            KC_DEL,
    KC_SPC,    KC_BSPC,    LT(L_NUM, KC_ESC),
  ...
  CK_GAME,     _______,    _______,    _______,    _______,    _______,    KC_EQL,
                          KC_RBRC,    KC_QUOT,    _______,     _______,    _______,

              _______,    _______,
                          _______,
  KC_ESC,     LT(KC_RCTL, KC_TAB),    LT(L_NAV,KC_ENT)
),
